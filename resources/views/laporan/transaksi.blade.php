                ...
                <div class="card-body">
                  ...
                  <div class="btn-group dropdown">
                        ...
                        <div class="btn-group dropdown">
                          ...
                          <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
                            <a class="dropdown-item" href="{{url('laporan/trs/excel')}}"> Semua </a>
                            <a class="dropdown-item" href="{{url('laporan/trs/excel?status=belum')}}"> Belum Lunas </a>
                            <a class="dropdown-item" href="{{url('laporan/trs/excel?status=lunas')}}"> Lunas </a>
                          </div>
                        </div>
                </div>
              </div>
